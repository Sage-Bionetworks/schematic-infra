...
class DockerFargateStack(Stack):
    ...
    def __init__(self, scope: Construct, context: str, env: dict, vpc: ec2.Vpc, **kwargs) -> None:
        ...
        #
        load_balanced_fargate_service.target_group.configure_health_check(protocol="https", interval=Duration.seconds(120), timeout=Duration.seconds(60), path="/v1/ui/", healthy_http_codes="200-308", unhealthy_threshold_count=5)
